...
export default async function GeotagReportPage({ searchParams }: { searchParams: { date?: string } }) {
    ...
    return (
        <div className="min-h-screen bg-[#FAFAFA] p-8 pb-32">
            <header className="mb-8">
                ...
                <h1 className="text-4xl font-black text-slate-900 tracking-tighter">Live Operations Geotag.</h1>
